...
export const CRITTERDLE_CONFIG: DndleConfig<Monster> = {
  ...
  itemLabel: "Monster",
  archiveName: "MONSTER ARCHIVE",
  resultsTitle: "The Tracks",
  selectPrompt: "Select a creature from the Monster Archive.",
  readyPrompt: "Ready to track your guess.",
  actionLabel: "HUNT",
  howTitle: "Find the monster",
  howIntro: "You have six guesses. Compare each result to identify the monster hidden in the archive.",
  howSteps: ["Choose a monster from the archive and submit your guess.", "Use the colors to compare all seven monster properties.", "Follow the arrows to narrow down ordered values."],
  arrowTraits: "CR, size, armor class, hit points and top speed",
  successKicker: (guesses) => `TRACKED IN ${guesses} GUESSES`,
  failureKicker: "THE TRAIL GOES COLD",
  nextLabel: "NEXT MONSTER IN",
  shareQuestion: "Which monster is hiding in the archive today?",
